            ...
            <div className=" grid items-center gap-12 lg:grid-cols-2">
              <div className="mt-12 lg:mt-0">
                <h1 className="mb-16 text-5xl font-bold tracking-tight text-[hsl(218,81%,95%)] md:text-6xl xl:text-7xl">
                  Best student will get a <br /><span className="text-[hsl(218,81%,75%)]">Macbook, so?</span>
                </h1>
...
<div class="container my-24 mx-auto md:px-6">
  ...
  <section class="mb-32 text-center">
    <h2 class="mb-20 text-3xl font-bold">Why we are special?</h2>
      ...
      <div class="mb-12 lg:mb-0">
        <div
          ...
          <div class="flex justify-center">
            <div class="-mt-8 inline-block rounded-full bg-primary-100 p-4 text-teal-500 shadow-md">
  ...
  <section class="mb-32 text-center">
    <div class="flex flex-wrap justify-center">
      <div class="flex-basis w-full shrink-0 grow-0 md:w-10/12 md:px-3 lg:w-8/12 xl:w-6/12">
        <div class="mb-6 inline-block rounded-full bg-teal-500 p-4 shadow-lg shadow-primary/30 dark:shadow-primary/20">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
        ...
        <h2 class="mb-6 text-3xl font-bold">Subscribe us for latest course</h2>

        <p class="mb-12 text-xl text-neutral-500 dark:text-teal-500">
          We will notify you for latest course details.
        </p>
        ...
        <div class="mb-6 flex-row md:mb-0 md:flex">
          ...
          <button type="submit"
            class="inline-block rounded bg-teal-500 px-7 pt-3 pb-2.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
...
<div class="container my-24 mx-auto md:px-6">
  <section class="mb-32 text-center">
    <h2 class="mb-12 text-3xl font-bold">Course Review</h2>
    ...
    <div class="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
      <div class="mb-12 md:mb-0">
        ...
        <h6 class="mb-4 font-medium text-primary dark:text-teal-500">
        Arabic Class
        </h6>
        <p class="mb-4">
